...
# Form implementation generated from reading ui file 'C:\Users\eee\Desktop\cwodmr\GUI\ui_files\GUI.ui'
#
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.widget.setGeometry(QtCore.QRect(10, 60, 601, 231))
        self.widget.setObjectName("widget")
        self.groupBox = QtWidgets.QGroupBox(self.centralwidget)
        self.groupBox.setGeometry(QtCore.QRect(10, 310, 271, 291))
        self.groupBox.setObjectName("groupBox")
        self.formLayoutWidget = QtWidgets.QWidget(self.groupBox)
        self.formLayoutWidget.setGeometry(QtCore.QRect(10, 20, 251, 301))
        ...
        self.x_roiLabel.setObjectName("x_roiLabel")
        ...
        self.x_roiLineEdit.setEnabled(True)
        self.x_roiLineEdit.setObjectName("x_roiLineEdit")
        ...
        self.y_roiLabel.setObjectName("y_roiLabel")
        ...
        self.y_roiLineEdit.setEnabled(True)
        self.y_roiLineEdit.setObjectName("y_roiLineEdit")
        self.formLayout.setWidget(7, QtWidgets.QFormLayout.FieldRole, self.y_roiLineEdit)
        self.roi_widthLabel = QtWidgets.QLabel(self.formLayoutWidget)
        self.roi_widthLabel.setObjectName("roi_widthLabel")
        self.formLayout.setWidget(8, QtWidgets.QFormLayout.LabelRole, self.roi_widthLabel)
        self.roi_widthLineEdit = QtWidgets.QLineEdit(self.formLayoutWidget)
        self.roi_widthLineEdit.setEnabled(True)
        self.roi_widthLineEdit.setObjectName("roi_widthLineEdit")
        self.formLayout.setWidget(8, QtWidgets.QFormLayout.FieldRole, self.roi_widthLineEdit)
        self.roi_heightLabel = QtWidgets.QLabel(self.formLayoutWidget)
        self.roi_heightLabel.setObjectName("roi_heightLabel")
        self.formLayout.setWidget(9, QtWidgets.QFormLayout.LabelRole, self.roi_heightLabel)
        self.roi_heightLineEdit = QtWidgets.QLineEdit(self.formLayoutWidget)
        self.roi_heightLineEdit.setEnabled(True)
        self.roi_heightLineEdit.setObjectName("roi_heightLineEdit")
        self.formLayout.setWidget(9, QtWidgets.QFormLayout.FieldRole, self.roi_heightLineEdit)
        self.groupBox_2 = QtWidgets.QGroupBox(self.centralwidget)
        self.groupBox_2.setGeometry(QtCore.QRect(340, 310, 221, 211))
        ...
        self.groupBox_3.setGeometry(QtCore.QRect(310, 530, 281, 171))
        ...
        self.widget_1.setGeometry(QtCore.QRect(910, 440, 321, 311))
        self.widget_1.setObjectName("widget_1")
        self.pushButtonCameraImage = QtWidgets.QPushButton(self.centralwidget)
        self.pushButtonCameraImage.setGeometry(QtCore.QRect(770, 500, 121, 28))
        self.pushButtonCameraImage.setObjectName("pushButtonCameraImage")
        self.pushButtonStopShowing = QtWidgets.QPushButton(self.centralwidget)
        self.pushButtonStopShowing.setGeometry(QtCore.QRect(770, 550, 121, 28))
        self.pushButtonStopShowing.setObjectName("pushButtonStopShowing")
        self.widget_2 = QtWidgets.QWidget(self.centralwidget)
        self.widget_2.setGeometry(QtCore.QRect(630, 60, 601, 231))
        self.widget_2.setObjectName("widget_2")
        self.pushButtonHprofile = QtWidgets.QPushButton(self.centralwidget)
        self.pushButtonHprofile.setGeometry(QtCore.QRect(730, 300, 121, 28))
        self.pushButtonHprofile.setObjectName("pushButtonHprofile")
        self.pushButtonHprofileStop = QtWidgets.QPushButton(self.centralwidget)
        self.pushButtonHprofileStop.setGeometry(QtCore.QRect(960, 300, 121, 28))
        self.pushButtonHprofileStop.setObjectName("pushButtonHprofileStop")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.roi_widthLabel.setText(_translate("MainWindow", "roi_width"))
        self.roi_heightLabel.setText(_translate("MainWindow", "roi_height"))
        ...
        self.pushButtonCameraImage.setText(_translate("MainWindow", "camera image"))
        self.pushButtonStopShowing.setText(_translate("MainWindow", "stop showing"))
        self.pushButtonHprofile.setText(_translate("MainWindow", "horizontal line profile"))
        self.pushButtonHprofileStop.setText(_translate("MainWindow", "stop it"))
