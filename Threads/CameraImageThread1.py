...
class CameraImageThread(QtCore.QThread):
    """
    ...
    def run(self):
        ...
        self.is_start = int(self.parameters['is_start'])
        self.is_frame_close = int(self.parameters['is_frame_close'])
        if self.is_start == 0:
            fig = plt.figure()
                ...
                try:
                    ...
                    for j in range(1, NUM_FRAMES + 1):
                        ...
                        if frame is not None:
                            ...
                            #
                            # if self.is_start == 0 and self.is_frame_close == 0:
                            #
                            ...
                            #     # fig = plt.figure()
                            #     ax = plt.gca()
                            #     ax.set_title('y = '+str(self.roi_height//2),fontsize=14,color='r')
                            #     plt.imshow(img, cmap='gray')
                            #     plt.axhline(y=self.roi_height//2, color='r', linestyle='-')
                            #     plt.savefig('redline.png')
                            #     plt.pause(0.1)
                            #     fig.clf()
